...
# Run with: xvfb-run godot --headless --script test_floor7_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor7_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor7.tscn ---")
	var path = "res://scenes/Floor7.tscn"
