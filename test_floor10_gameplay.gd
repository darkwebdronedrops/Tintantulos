...
# Run with: xvfb-run godot --headless --script test_floor10_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor10_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor10.tscn ---")
	var path = "res://scenes/Floor10.tscn"
