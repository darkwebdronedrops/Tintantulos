...
# Run with: xvfb-run godot --headless --script test_floor9_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor9_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor9.tscn ---")
	var path = "res://scenes/Floor9.tscn"
