...
# Run with: xvfb-run godot --headless --script test_floor2_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor2_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor2.tscn ---")
	var path = "res://scenes/Floor2.tscn"
