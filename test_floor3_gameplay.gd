...
# Run with: xvfb-run godot --headless --script test_floor3_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor3_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor3.tscn ---")
	var path = "res://scenes/Floor3.tscn"
