...
# Run with: xvfb-run godot --headless --script test_floor6_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor6_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor6.tscn ---")
	var path = "res://scenes/Floor6.tscn"
