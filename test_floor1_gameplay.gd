...
# Run with: xvfb-run godot --headless --script test_floor1_gameplay.gd
...
func _init():
	log_file = FileAccess.open("/tmp/floor1_gameplay_test.log", FileAccess.WRITE)
...
func _run_tests():
	...
	# Test 1: Load scene
	_log("\n--- Test: Load Floor1.tscn ---")
	var path = "res://scenes/Floor1.tscn"
