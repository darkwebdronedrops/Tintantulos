...
## Date: 2026-07-20 (Merged)
## Compiled by: Kimi (OpenClaw Instance)
## Cards: 245/240 (100% Complete + 5 Expansion) ✅
...
This is **intentional** and **not a bug**. Do not "fix" any floor to use WASD free movement, arrow keys, or square-grid navigation. The game is designed around 6-directional hex movement. All floor controllers (`Floor1Controller.gd`, `Floor3Controller.gd`, and future floors) implement this scheme.
...
5. [Keyword System](#keyword-system)
   ...
   - Aberration
6. [Factions](#factions)
7. [Enemies by Faction](#enemies-by-faction)
8. [Overlay Cards](#overlay-cards)
   - Arcane
   - Divine
   - Infernal
9. [Dragon System](#dragon-system-in-progress)
...
15. [Dragon Cards](#dragon-cards-10-cards--complete)
16. [Card Count & Status](#card-count--status)
...
**Bone:** Adds Shield on cast. Defensive keyword — gain block/protection when playing Bone cards. Enables shield-stacking strategies and defensive Undead builds.
### ELEMENTAL
**CHARGE:** The core Elemental resource. Builds up over turns via Nature and is spent for burst effects via Flow. Tracked per card or globally depending on the effect. Maximum CHARGE stacks vary by card (typically 3-6).

**Nature:** The *sustained/growth* side of Elemental. Persistent buffs that scale with time and CHARGE accumulation.
- **Effect:** Adds +1 CHARGE per turn while in play (cards, fields, summons)
- **Damage scaling:** +2 damage per CHARGE stack when dealing damage
- **Growth:** Summons with Nature gain +1 attack per turn (stacks with CHARGE)
- **Example:** *"Nature: Growth +1 atk/turn"* — summon grows stronger each turn
- **Example:** *"Nature: ignores Shield"* — CHARGE-built attacks bypass defenses

**Flow:** The *spending/efficiency* side of Elemental. Burn accumulated CHARGE for burst damage, cost reduction, or enhanced effects.
- **Effect:** Consume CHARGE stacks for bonus damage, reduced costs, or extra effects
- **Damage scaling:** +1d6 per CHARGE consumed (varies by card, typically max +2d6 to +3d6)
- **Cost reduction:** *"Flow: next card costs -2 Attention (min 1)"*
- **Example:** *"Flow: consume CHARGE, +1d6 per stack"* — spend all CHARGE for big burst
- **Example:** *"Flow: +1d6 per CHARGE (max +3d6)"* — capped burst damage

**Play Pattern:**
1. **Build phase:** Play Nature cards/fields/summons to accumulate CHARGE over 2-3 turns
2. **Spend phase:** Use Flow cards to unleash CHARGE for massive burst damage or efficiency
3. **Repeat:** Nature cards persist, so CHARGE rebuilds automatically for the next cycle

**Visual:** Elemental CHARGE is represented by glowing energy (blue/white) accumulating around the caster. Flow spend shows energy discharging in a blast.
...
#### Unlock Condition
- **Trigger:** Player deck reaches **50 cards**
...
**Note:** The Compiler is also the name of the deck-size danger mechanic (60+ cards = deck becomes unplayable). The secret boss and the deck mechanic share a name but are different systems.
...
**Total Floors:** 10
**Floors Designed:** 1/10
**Status:** Floor 4 (The Abandoned Mall) complete

### Floor Progress

| Floor | Name | Theme | Faction Focus | Status |
|-------|------|-------|---------------|--------|
| 1-2 | Tutorial Mines | Starter basics | Goblin | ⏳ Not designed |
| 3 | The Gearworks | First complex challenge | Construct | ⏳ Not designed |
| **4** | **The Abandoned Mall** | **Psychological horror** | **Aberration** | ✅ **Complete** |
| 5 | Elemental Depths | CHARGE mastery | Elemental | ⏳ Not designed |
| 6 | The Bone Treasury | Memory/grasp mechanics | Undead | ⏳ Not designed |
| 7 | The Pact Chambers | Temptation/choice | Demon | ⏳ Not designed |
| 8 | The Confluence | All factions combined | Mixed | ⏳ Not designed |
| 9 | Dragon's Approach | Boss gauntlet | Dragon prep | ⏳ Not designed |
| 10 | The Compiler's Sanctum / Dragon's Lair | Final confrontation | Dragon OR Compiler (Secret) | ⏳ Not designed |

**Note:** Floor 10 normally features the Dragon. If player deck reached 50 cards, The Compiler awakens and replaces the Dragon encounter.

### Floor 4: The Abandoned Mall (Complete)

**Location:** `FLOOR_04_ABANDONED_MALL.md`
**Architecture:** Diamond-shaped hex grid, 3 levels (garage, main floor, food court)
**Key Features:**
- Broken central escalator (unpredictable movement)
...
**Enemies:** 10 Aberration enemies (The Duplicate, The Loop, The Forgotten, The Lag, Autosave, Cursor, Bug + 3 starter tier)
**Boss:** Mirror Self (HP = player HP, copies actions)
**Loot:** Memory Cards (heal but apply emotional vulnerability)
